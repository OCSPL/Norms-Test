...
def calculate_mdea(stock_summary, bom_summaries_df):
    # Define stages + name_filters (can expand this list as needed)
    stages = [
        ('MDEA N-BUTANOL MLR', ['MDEA RECOVERED N-BUTANOL'])
    ]
...
def calculate_con_mdea(Con_qty,stock_summary):
    # Filter the stock_summary DataFrame for '2,4,6 RECOVERED MESITYLENE'
    mesitylene_row = stock_summary[stock_summary['Item Name'] == 'MDEA N-BUTANOL MLR']
